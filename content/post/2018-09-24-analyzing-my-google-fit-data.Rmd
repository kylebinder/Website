...
fit_data <- read.csv("/Users/ctoohey/Kyle_stuff/Website/data/Daily Summaries.csv") %>%
...
In the next chunk, we'll look at the distribution of daily steps by day of the week (Sunday, Monday, etc.). Somewhat interestingly, my median step daily step count is fairly constant across the week. The distribution of steps is the widest on the weekends, however (some very inactive Fridays, Saturdays, and Sundays, but some really active ones, too!).
```{r step_count_by_day}
